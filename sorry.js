...
const addEndingSection = () => {
    ...
    sorryMessage.className = "sorryMessage";
    sorryMessage.innerHTML = "I really am sorry Bubu<br>Maaf kr do na pleaseeeeee"
...
var sorryFor = [
    ...
    "And make things right, and make them fine.",
    "But since I can't undo the past,",
    "I'll do my best to make things last,",
...
document.getElementById('customScroll').addEventListener('scroll', revealAnimation);
...
const inYourDeramsBtnClicked = function () {
    var dontWantToGiveChance = confirm("Are you sure you don't want to give me a chance?")
    if(dontWantToGiveChance == true)
        alert("I'm sorry, but this feature is not available yet. XD");
    else
        closeActiveModal();
}
